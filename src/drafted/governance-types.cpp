...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BopuCoinNetwork") type = BopuCoinNetwork;
    if(strType == "BopuCoinNetworkVariable") type = BopuCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BopuCoinNetwork) s = "BopuCoinNetwork";
    if(type == BopuCoinNetworkVariable) s = "BopuCoinNetworkVariable";
