    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("BopuCoin Core");
    ...
    QString copyrightTextBopuCoin   = QChar(0xA9)+QString(" 2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The BopuCoin Core developers"));
    ...
    }else if (GUIUtil::getThemeName() == "bopucoin-dark"){
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextBopuCoin);
