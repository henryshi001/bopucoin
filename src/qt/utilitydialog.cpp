    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BopuCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BopuCoin Core"));
        ...
        licenseInfoHTML.replace(uri, "<a style=\"color: #00D1B2;\" href=\"\\1\">\\1</a>");
        ...
        QString header = tr("Usage:") + "\n" +
            "  bopucoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BopuCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BPC, 0.1 BPC, 1 BPC and 10 BPC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BopuCoin Core is shutting down...") + "<br /><br />" +
