    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BopuCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BopuCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bopucoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BopuCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BopuCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BopuCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BopuCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BopuCoin addresses"));
    ...
    usedSendingAddressesAction = new QAction(QIcon(":/icons/" + theme + "/address-book-white"), tr("&Sending addresses..."), this);
    usedSendingAddressesAction->setStatusTip(tr("Show the list of used sending addresses and labels"));
    usedReceivingAddressesAction = new QAction(QIcon(":/icons/" + theme + "/address-book-white"), tr("&Receiving addresses..."), this);
    usedReceivingAddressesAction->setStatusTip(tr("Show the list of used receiving addresses and labels"));

    openAction = new QAction(QIcon(":/icons/" + theme + "/folder-icon"), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a bopucoin: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BopuCoin Core help message to get a list with possible BopuCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BopuCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BopuCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("BopuCoin Core"); // default title
    ...
    menu(0)
{
    ...
    setStyleSheet(QString("QLabel { color : #fff }").arg(platformStyle->SingleColor().name()));
}
