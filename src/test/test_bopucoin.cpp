...
#define BOOST_TEST_MODULE BopuCoin Test Suite

#include "test_bopucoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bopucoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
