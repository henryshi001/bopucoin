/* src/config/bopucoin-config.h.  Generated from bopucoin-config.h.in by configure.  */
/* src/config/bopucoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BOPUCOIN_CONFIG_H

#define BOPUCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/bopucoin/bopucoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BopuCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BopuCoin Core 1.6.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bopucoin"
