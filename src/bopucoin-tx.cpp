...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BopuCoin Core bopucoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bopucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bopucoin transaction") + "\n" +
              "  bopucoin-tx [options] -create [commands]   " + _("Create hex-encoded bopucoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bopucoin transaction
