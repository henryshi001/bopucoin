...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const Consensus::Params& params) {
    ...
    /* current difficulty formula, bopucoin - DarkGravity v3, written by Evan Duffield - evan@bopucoin.org */
...
{
    // start on legacy until enough blocks
    if ((pindexLast->nHeight + 1) < 25) {
