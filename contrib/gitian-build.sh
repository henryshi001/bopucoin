...
then
	# Make output folder
	mkdir -p "./bopucoin-binaries/${VERSION}"
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit bopucoin=${COMMIT} --url bopucoin=${url} ../bopucoin/contrib/gitian-descriptors/gitian-linux.yml
	    ...
	    mv build/out/bopucoin-*.tar.gz build/out/src/bopucoin-*.tar.gz ../bopucoin-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit bopucoin=${COMMIT} --url bopucoin=${url} ../bopucoin/contrib/gitian-descriptors/gitian-win.yml
	    ...
	    mv build/out/bopucoin-*.zip build/out/bopucoin-*.exe ../bopucoin-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit bopucoin=${COMMIT} --url bopucoin=${url} ../bopucoin/contrib/gitian-descriptors/gitian-osx.yml
	    ...
	    mv build/out/bopucoin-*.tar.gz build/out/bopucoin-*.dmg ../bopucoin-binaries/${VERSION}
	fi
	# AArch64
	if [[ $aarch64 = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit bopucoin=${COMMIT} --url bopucoin=${url} ../bopucoin/contrib/gitian-descriptors/gitian-aarch64.yml
	    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../bopucoin/contrib/gitian-descriptors/gitian-aarch64.yml
	    mv build/out/bopucoin-*.tar.gz build/out/src/bopucoin+-*.tar.gz ../bopucoin-binaries/${VERSION}
	fi
	popd || exit
...
then
	...
	echo ""
	./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-aarch64 ../bopucoin/contrib/gitian-descriptors/gitian-aarch64.yml
	# Signed Windows
	echo ""
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../bopucoin/contrib/gitian-descriptors/gitian-win-signer.yml
	    ...
	    mv build/out/bopucoin-*win64-setup.exe ../bopucoin-binaries/${VERSION}
	    mv build/out/bopucoin-*win32-setup.exe ../bopucoin-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../bopucoin/contrib/gitian-descriptors/gitian-osx-signer.yml
	    ...
	    mv build/out/bopucoin-osx-signed.dmg ../bopucoin-binaries/${VERSION}/bopucoin-${VERSION}-osx.dmg
	fi
	popd || exit
