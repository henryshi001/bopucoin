...
BopuCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 11000 for connections and services them.
...
However, in open source software such as BopuCoin Core, where everyone uses
...
pay attention to for reviewers of BopuCoin Core code.

General BopuCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BopuCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
