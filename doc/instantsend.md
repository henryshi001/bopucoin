...
This mechanism has been integrated into Bitcore-Node-BopuCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bopucoin/insight-api-bopucoin#web-socket-api](https://github.com/bopucoin/insight-api-bopucoin#web-socket-api)
* API: [https://github.com/bopucoin/insight-api-bopucoin#instantsend-transactions](https://github.com/bopucoin/insight-api-bopucoin#instantsend-transactions)
...
By default, the BopuCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BopuCoin Core daemon:
